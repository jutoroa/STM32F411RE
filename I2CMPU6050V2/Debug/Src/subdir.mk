...
C_SRCS += \
../Src/mainI2CMPU6050V1.c \
../Src/syscalls.c \
../Src/sysmem.c 

OBJS += \
./Src/mainI2CMPU6050V1.o \
./Src/syscalls.o \
./Src/sysmem.o 

C_DEPS += \
./Src/mainI2CMPU6050V1.d \
./Src/syscalls.d \
./Src/sysmem.d 
...
clean-Src:
	-$(RM) ./Src/mainI2CMPU6050V1.d ./Src/mainI2CMPU6050V1.o ./Src/mainI2CMPU6050V1.su ./Src/syscalls.d ./Src/syscalls.o ./Src/syscalls.su ./Src/sysmem.d ./Src/sysmem.o ./Src/sysmem.su
