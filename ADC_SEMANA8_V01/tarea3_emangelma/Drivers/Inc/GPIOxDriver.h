 ...
 * @brief          : Archivo .h periférico GPIOx
 ************************************************************************************************************************************************************
 * Este programa contiene la documentación necesaria para trabajar con el perfiérico GPIOx.
 ************************************************************************************************************************************************************
 */
#ifndef	INC_GPIOXDRIVER_H_
#define INC_GPIOXDRIVER_H_

// Al incluir este archivo, se está incluyendo también el correspondiente al GPIOx.
#include <stm32f4xx.h>
