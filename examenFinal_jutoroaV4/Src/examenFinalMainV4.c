...
uint8_t		buzzerFlag			= false;
uint8_t		buzzerFlag2			= false;
...
*/
		...
		if((buzzerFlag == true) && (buzzerFlag2 == true)){
...
void initSystem(void){
	...
	handlerTimer5.timerConfig.Timer_period				= 400;
