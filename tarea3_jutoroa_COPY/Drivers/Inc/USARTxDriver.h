...
#define USART_INTERRUPT_RX_DISABLE		1
#define USART_INTERRUPT_TX_ENABLE		2
#define USART_INTERRUPT_TX_DISABLE		3
#define USART_INTERRUPT_RXTX_ENABLE		4
#define USART_INTERRUPT_RXTX_DISABLE	5
